...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/nikolichnik/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/nikolichnik/LARBS/master/progs.csv"
...
installationloop() { \
	...
	while IFS=, read -r tag branch program comment; do
		n=$((n+1))
...
dialog --title "LARBS Installation" --infobox "Finally, installing \`libxft-bgra-git\` to enable color emoji in suckless software without crashes." 5 70
